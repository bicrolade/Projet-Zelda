...
[CustomEditor(typeof(EnableComponentsOnDestroyAll)), CanEditMultipleObjects]
public class EnableComponentsOnDestroyAllEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		EditorGUILayout.BeginVertical(UIHelper.mainStyle);
		{
			...
			{
				toolBarTab = GUILayout.Toolbar(toolBarTab, new string[] { "General", "Components"}, GUILayout.MinHeight(25));
